...
class CENGFlight
{
    ...
    int selecting_next_airport(const std::vector<bool> &visited_list,const std::vector<bool> &selected, int start)const;
void bfs(std::vector<bool> &visited,std::vector<std::string>& airlineNames,
                                    const int start_index,bool &flag) const;
    void selecting_airline(std::vector<bool> &visited, std::vector<std::string>& airlineNames,
